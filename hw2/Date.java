...
class Date {
 ...
 public Date(String s) {
	 if(s.matches("(\\d{1,2})\\/(\\d{1,2})\\/(\\d{1,4})")) {    //Regular expressions patterns 
		     String[] d=s.split("/");   // String split method
  ...
  public int dayInYear() {
	  ...
	  for (int m=1; m<this.month; m++) {
		  total = total + daysInMonth(m,this.year);
	  }
	  total = total + this.day;
      return total;                           // replace this line with your solution
  }
  ...
  public int difference(Date d) {
	  ...
	  return s1-s2;                          // replace this line with your solution
  }
